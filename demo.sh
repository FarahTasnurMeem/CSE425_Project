...
echo "44 sort in ascending order with duplicates by sex:"
echo "45 sort in ascending order with duplicates by cp:"
echo "46 sort in ascending order with duplicates by tribps:"
echo " 47 sort in ascending order with duplicates by chol:"
echo " 48 sort in ascending order with duplicates by fbs:"
echo " 49  sort in ascending order with duplicates by restecg:"
echo " 50 sort in ascending order with duplicates by thalachh:"
echo " 51 sort in ascending order with duplicates by exng:"
echo " 52 sort in ascending order with duplicates by oldpeak:"
echo " 53 sort in ascending order with duplicates by slp:"
echo " 54 sort in ascending order with duplicates by caa:"
echo " 55 sort in ascending order with duplicates by thall:"
echo " 56 sort in ascending order with duplicates by output:"
